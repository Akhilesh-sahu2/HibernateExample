...
public class ManageEmployeeSetMappings {
	   ...
	   public Integer addEmployee(String fname, String lname, 
	      ...
	      try{
	         ...
	         EmployeeSetMappings employee = new EmployeeSetMappings(fname, lname, salary);
	   ...
	   public void listEmployees( ){
	      ...
	      try{
	         ...
	         for (Iterator iterator1 = 
	            ...
	            EmployeeSetMappings employee = (EmployeeSetMappings) iterator1.next(); 
	            ...
	            for (Iterator iterator2 = 
	            	...
	            	CertificateSetMappings certName = (CertificateSetMappings) iterator2.next(); 
	   ...
	   public void updateEmployee(Integer EmployeeID, int salary ){
	      ...
	      try{
	         tx = session.beginTransaction();
	         EmployeeSetMappings employee = 
	                    (EmployeeSetMappings)session.get(EmployeeSetMappings.class, EmployeeID); 
